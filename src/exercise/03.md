...
- How useContext is implemented and how it can be used
- Also learned that it usually isn't necessary to use and in situations (e.g,
  prop drilling) were useContext can be a solution there are usually better ways
  to solve it, (lifting state or component composition e.g.)
- I learned how to easily implement a check to ensure the user tries to access
  context from within the contexts provider
- I dived deeper into creating custom hooks and learned how a consumer hook can
  be used to handle before mentioned context check
