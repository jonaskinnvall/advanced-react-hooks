...
- useImperativeHandle and how it can be used in tandem with forwardRef to let a
  user pass a ref from a parent component and allow the parent component to a
  call that refs imperative methods (e.g, scrollToTop and scrollToBottom in this
  exercise)
- useImperativeHandle is rarely used and in case you think about using it, you
  should question if it really is needed and if there isn't another way to do it
