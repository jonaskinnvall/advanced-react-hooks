...
- useLayoutEffect and got insight into in what _rare_ cases it should be used
  instead of useEffect
  - Which is in cases where we're making observable changes to the DOM e.g.,
    updating scroll position as in this exercise
  - This is to make our DOM update before React updates the DOM so that the
    browser doesn't have to paint twice
